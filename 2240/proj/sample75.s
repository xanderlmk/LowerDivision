...
.data # data segment begins here
	fname1:    .asciiz "chadsteve.txt"
	fname:    .asciiz "csub3.ppm"
    fname2:    .asciiz "minecraftskin.txt"
...
read_loop:
    ...
    move $t7, $v0               # store integer value back into $t7
     ...
     beq $t7, 6, p6file          # if $t7==6, this is a p6 file, so jump to subroutine of a p6 file
...
innerp6:                  # top of inner loop                |          |
	...
	syscall
	lbu $t4, read_buf      # get character from read buffer
